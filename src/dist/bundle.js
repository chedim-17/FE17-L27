...
var ListNameService = __webpack_require__(6);
var ListNameSearch = __webpack_require__(8);
...
var Backbone = __webpack_require__(0);
var ListNameData = __webpack_require__(7);
...
var ListNameManager = Backbone.View.extend({
    ...
    deleteDataRow: function deleteDataRow(e) {
...
var Modal = Backbone.View.extend({
    ...
    resetPersonData: function resetPersonData() {
        $('#firstName').html('');
        $('#lastName').html('');
    }
